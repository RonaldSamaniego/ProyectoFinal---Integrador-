...
private void actualizarTablaModelos(String buscar) {
 ...
 int fila = listado.rowAtPoint(evt.getPoint());
       FrmPedido.txtcodcliente.setText( listado.getValueAt(fila, 0).toString());
             FrmPedido.txtruccliente.setText( listado.getValueAt(fila, 1).toString());
       FrmPedido.txtcliente.setText( listado.getValueAt(fila, 2).toString());
       this.dispose();
