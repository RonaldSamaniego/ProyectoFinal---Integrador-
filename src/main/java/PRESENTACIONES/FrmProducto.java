...
public class FrmProducto extends javax.swing.JInternalFrame {
 ...
 private void llenarComboBoxModelos() {
        DefaultComboBoxModel<String> modelo = negocioProducto.obtenerModelosActivos();
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addContainerGap()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cbomodelo, javax.swing.GroupLayout.PREFERRED_SIZE, 330, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addComponent(txtprecio, javax.swing.GroupLayout.PREFERRED_SIZE, 330, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(txtstock, javax.swing.GroupLayout.PREFERRED_SIZE, 330, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(jLabel7)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(cbomodelo, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel8)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jCheckestado)
...
private boolean Validar() {
    if (txtdescripcion.getText().isEmpty()) {
        JOptionPane.showMessageDialog(null, "Por favor ingrese la Descripcion", "Error de Validación", JOptionPane.ERROR_MESSAGE);
    ...
    if (txtprecio.getText().isEmpty()) {
        JOptionPane.showMessageDialog(null, "Por favor ingrese el precio .", "Error de Validación", JOptionPane.ERROR_MESSAGE);
        txtprecio.requestFocus();
        return false;
    }
    
    if (txtstock.getText().isEmpty()) {
        JOptionPane.showMessageDialog(null, "Por favor ingrese el stock.", "Error de Validación", JOptionPane.ERROR_MESSAGE);
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
        ...
        if (Validar()) {
            ...
            int idModelo = cbomodelo.getSelectedIndex();
            int idUsuarioRegistro = Integer.parseInt(Frm_Menu.txtcodusuario.getText());
            int estado = jCheckestado.isSelected() ? 1 : 0;

            
            boolean insertado = negocioProducto.insertarregistro(idModelo, descripcion, precio, stock, idUsuarioRegistro, estado);

            if (insertado) {
                JOptionPane.showMessageDialog(this, "Producto guardado correctamente.", "Guardar", JOptionPane.INFORMATION_MESSAGE);
                limpiar();
                actualizarTablaModelos("");
            } else {
                 JOptionPane.showMessageDialog(this, "no se a guardado los datos.", "Datos", JOptionPane.INFORMATION_MESSAGE);
            }
