...
private void actualizarTablaModelos(String buscar) {
    DefaultTableModel modelo = new Ncliente().mostrar(buscar);
...
private boolean Validar() {
   ...
   if (Validar()) {
        ...
        boolean insertado = negocioCliente.insertarregistro(ruc, razonSocial, direccion, telefono, representanteLegal, idUsuarioRegistro, estado);

        if (insertado) {
           
            
               JOptionPane.showMessageDialog(this, "Cliente guardado correctamente.", "Guardar", JOptionPane.INFORMATION_MESSAGE);
