...
import NEGOCIO.NempresaDestajero;
...
public class FrmDestajero extends javax.swing.JInternalFrame {

      private final NempresaDestajero  negocioDestajero = new NempresaDestajero();
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addComponent(txtruc, javax.swing.GroupLayout.PREFERRED_SIZE, 330, javax.swing.GroupLayout.PREFERRED_SIZE)
                                ...
                                .addComponent(txtrepresentante, javax.swing.GroupLayout.PREFERRED_SIZE, 330, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(jLabel5)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtrazon, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel6)
                        ...
                        .addComponent(txtrepresentante, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel4)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jCheckestado)
...
private void actualizarTablaModelos(String buscar) {
    DefaultTableModel modelo = new NempresaDestajero().mostrar(buscar);
    listado.setModel(modelo);
}

private boolean Validar() {
    if (txtruc.getText().isEmpty()) {
        JOptionPane.showMessageDialog(null, "Por favor ingrese el RUC.", "Error de Validación", JOptionPane.ERROR_MESSAGE);
        txtruc.requestFocus();
        return false;
    }
    
    if (txtruc.getText().length() < 11) {
        JOptionPane.showMessageDialog(null, "El RUC debe tener al menos 11 dígitos.", "Error de Validación", JOptionPane.ERROR_MESSAGE);
        txtruc.requestFocus();
        return false;
    }
    
    if (txtrazon.getText().isEmpty()) {
        JOptionPane.showMessageDialog(null, "Por favor ingrese la Razón Social.", "Error de Validación", JOptionPane.ERROR_MESSAGE);
        txtrazon.requestFocus();
        return false;
    }
    
    if (txtdireccion.getText().isEmpty()) {
        JOptionPane.showMessageDialog(null, "Por favor ingrese la Dirección.", "Error de Validación", JOptionPane.ERROR_MESSAGE);
        txtdireccion.requestFocus();
        return false;
    }
    
    if (txttelefono.getText().isEmpty()) {
        JOptionPane.showMessageDialog(null, "Por favor ingrese el Teléfono.", "Error de Validación", JOptionPane.ERROR_MESSAGE);
        txttelefono.requestFocus();
        return false;
    }
    
    if (txtrepresentante.getText().isEmpty()) {
        JOptionPane.showMessageDialog(null, "Por favor ingrese el Representante Legal.", "Error de Validación", JOptionPane.ERROR_MESSAGE);
   ...
   if (Validar()) {
        ...
        boolean insertado = negocioDestajero.insertarregistro(ruc, razonSocial, direccion, telefono, representanteLegal, idUsuarioRegistro, estado);

        if (insertado) {
            JOptionPane.showMessageDialog(this, "Empresa Destajero guardado correctamente.", "Guardar", JOptionPane.INFORMATION_MESSAGE);
